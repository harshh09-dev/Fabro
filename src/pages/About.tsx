      ...
      <section className="relative h-[60vh] flex items-end pb-16">
        ...
        <div className="relative container mx-auto px-6">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-medium text-foreground">
            Crafted, Not <span className="italic">Manufactured</span>
          </h2>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-8 animate-on-scroll">
              ...
              <p className="font-body text-base text-muted-foreground leading-relaxed">
                ...
                weavers of Punjab, from the Zardozi craftsmen of Agra to the Kantha stitchers of Bengal. 
                Each community carries centuries of knowledge in their fingers.
              </p>
              <p className="font-body text-base text-muted-foreground leading-relaxed">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {artisans.map((artisan, i) => (
              <div key={artisan.id} className="animate-on-scroll" style={{ animationDelay: `${0.1 * i}s` }}>
                ...
                <h3 className="font-display text-lg font-medium text-foreground mb-1">{artisan.name}</h3>
                <p className="font-body text-xs text-muted-foreground mb-2">
                  {artisan.location} · {artisan.embroideryStyle} · {artisan.experience} years
                </p>
                <p className="font-body text-sm text-muted-foreground leading-relaxed">{artisan.story}</p>
              </div>
            ))}
          </div>
        </div>
