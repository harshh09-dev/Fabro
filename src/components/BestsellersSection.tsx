    ...
    <section className="py-32 md:py-40">
      <div className="container mx-auto px-6">
        <div className="flex items-end justify-between mb-16 animate-on-scroll">
          ...
          <Link
            to="/shop"
            className="hidden md:block font-body text-sm tracking-wider text-muted-foreground hover:text-primary transition-colors border-b border-primary/30 pb-1"
          >
            View All
          </Link>
        </div>
          ...
          {bestsellers.map((product, i) => (
            ...
            >
              <Link to={`/product/${product.id}`}>
                <div className="img-zoom aspect-[3/4] overflow-hidden mb-5 relative">
                  <img
        ...
        <div className="mt-12 text-center md:hidden">
          <Link
            to="/shop"
            className="font-body text-sm tracking-wider text-muted-foreground hover:text-primary transition-colors border-b border-primary/30 pb-1"
          >
            View All Products
          </Link>
        </div>
